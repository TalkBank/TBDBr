...
The goal of the R package 'talkbankDB' is to provide easy access to TalkBank data through through an R api.
...
For troubleshooting, an additional function, validPath(), will return whether a given query is valid.
...
More examples are located under [*articles*](https://rbcavanaugh.github.io/talkbank/articles/example-queries.html)
